...
8. 상단의 Google 로그인 후 **문서 보내기** 버튼으로 현재 문서 사본을 다른 사용자 이메일에 보낼 수 있습니다.
9. 사이드바 **받은함** 탭에서 받은 문서를 확인하고 **내 문서로 가져오기**를 누르면 IndexedDB 문서 목록에 복사됩니다.
10. 사이드바 **주소록** 탭에서 자주 보내는 사람을 저장하거나, 문서 보내기 화면에서 **주소록에 저장**을 체크해 자동 추가할 수 있습니다.
